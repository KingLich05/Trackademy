...
namespace Trackademy.Application.Persistance.migrations
{
    ...
    [Migration("20251126234714_AddMaterialsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trackademy.Domain.Users.GroupStudent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Trackademy.Domain.Users.Material", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Trackademy.Domain.Users.Payment", b =>
                {
                    ...
                    b.HasIndex("StudentId", "PeriodEnd");
            ...
            modelBuilder.Entity("Trackademy.Domain.Users.Material", b =>
                {
                    ...
                    b.HasOne("Trackademy.Domain.Users.User", "UploadedBy")
                        .WithMany()
